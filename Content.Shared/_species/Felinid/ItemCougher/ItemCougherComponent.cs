...
namespace Content.Shared._species.Felinid.ItemCougher;

/// <summary>
/// Transient component added to an entity that is in the process of coughing up an item.
/// Removed automatically once the item spawns.
/// </summary>
[RegisterComponent]

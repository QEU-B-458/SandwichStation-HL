...
public sealed class SurgerySystem : SharedSurgerySystem
{
    ...
    protected override void RefreshUI(EntityUid body)
    {
        ...
        var parts = _body.GetBodyChildren(body).Select(x => x.Id).ToList();
        ...
        EntityUid part)
    {
        ...
        var ev = new TryChangePartDamageEvent(
    ...
    {
        if (HasComp<SleepingComponent>(args.Body) || HasComp<PainNumbnessStatusEffectComponent>(args.Body))
            return;

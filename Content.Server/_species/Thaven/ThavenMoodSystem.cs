...
using Content.Shared._species.Thaven;
using Content.Shared._species.Thaven.Components;
...
// TODO: Add ThavenSharedMoodCount CVar. Was ImpCCVars.ThavenSharedMoodCount from _Impstation.
using Content.Shared.Mind;
using Content.Shared.Mindshield.Components;
using Robust.Shared.Audio.Systems;
using Robust.Shared.Utility;

namespace Content.Server._species.Thaven;
...
public sealed partial class ThavenMoodsSystem : SharedThavenMoodSystem
{
    ...
    {
        _sharedMoods.Clear();
        for (int i = 0; i < 3; i++) // TODO: Make this a CVar (was ImpCCVars.ThavenSharedMoodCount)
            TryAddSharedMood();
    }

using Content.Server._axiom.Power.Components;
using Content.Server.NodeContainer.EntitySystems;
using Content.Server.NodeContainer.Nodes;
using Content.Server.Shuttles.Events;
using Content.Shared._axiom.Power.Visuals;
using Content.Shared.NodeContainer;
using Robust.Server.GameObjects;

namespace Content.Server._axiom.Power.Systems;
...
public sealed class DockablePowerSystem : EntitySystem
{
    ...
    private void OnDock(Entity<DockablePowerComponent> ent, ref DockEvent args)
    {
        if (string.IsNullOrEmpty(ent.Comp.DockNodeName) ||
            ...
            !_nodeContainer.TryGetNode(nodeContainer, ent.Comp.DockNodeName, out DockableCableNode? dockableNode))
            return;

        _nodeGroup.QueueReflood(dockableNode);
    ...
    private void OnUndock(Entity<DockablePowerComponent> ent, ref UndockEvent args)
    {
        ...
        _nodeGroup.QueueNodeRemove(dockableNode);
